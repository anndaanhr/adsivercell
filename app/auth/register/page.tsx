          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Alert className="bg-blue-50 dark:bg-blue-950">
              ...
              <AlertDescription className="text-xs text-blue-600 dark:text-blue-400">
                After registration, you'll need to verify your email address to access all features.
              </AlertDescription>
            </Alert>
            ...
            <div className="flex items-start space-x-2">
              ...
              <div className="grid gap-1.5 leading-none">
                <label
                  htmlFor="agreeTerms"
                  className={`text-sm font-medium leading-none ${errors.agreeTerms ? "text-red-500" : ""}`}
                >
                  I agree to the{" "}
